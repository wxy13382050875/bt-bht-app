<template>
	<view class="app-content">
		...
		<bht-layout-container bg-color="#fff">
			<view class="profile-content">
				...
				<view class="aca-cell">
					...
					<view class="content">
						<input type="text" class="input" v-model="formData.idCode" placeholder="请输入证件号码" />
					</view>
				</view>
				<view class="aca-cell">
		...
		<mp-picker mode="multiLinkageSelector" @onConfirm="regionConfirm" :pickerValueDefault="regionDef" :pickerValueArray="regionPickerArry"
		 :deepLength="2" ref="regionPicker"></mp-picker>
	</view>
</template>
