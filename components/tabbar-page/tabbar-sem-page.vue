<template>
  <view
    v-show="pageFlag === tabBarFlag"
    class="sem-index-container"
  >
    <nav-bar-title title="边民互市二级交易市场"></nav-bar-title>
    <bht-layout-container bgColor="#F2F2F2">
      ...
      <view class="scan-list-container">
        ...
        >
          <view class="check">
            <nz-checkbox :circle="true"></nz-checkbox>
          </view>
          <view class="info">
