	...
	methods: {
		...
		upCallback(mescroll) {
			...
			this.getListDataFromNet(
				...
				curPageData => {
					...
					this.dataSource = this.dataSource.concat(curPageData); //追加新数据
				},
				() => {
					//联网失败的回调,隐藏下拉刷新的状态
					mescroll.endErr();
		...
		getListDataFromNet(pageNum, pageSize, successCallback, errorCallback) {
			...
			if (this.i === 0) {
				...
				this.params.statusCd = 10008;
			} else if (this.i === 2) {
				this.params.statusCd = 10016;
			} else if (this.i === 3) {
				this.params.statusCd = 10020;
			} else if (this.i === 4) {
				this.params.statusCd = 10024;
			}
